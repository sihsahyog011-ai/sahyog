...
function bindEvents() {
    ...
    .addEventListener(
      ...
      event => {
        ...
        document
          ...
          .textContent =
          "Your listing has been saved on this device.";
  ...
  document.addEventListener(
    ...
    event => {
      ...
      if (
        joinOverlay.classList.contains(
          "open"
        )
      ) {
        closeJoinModal();
